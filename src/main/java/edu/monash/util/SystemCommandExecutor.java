...
public class SystemCommandExecutor {
     ...
     */
    public SystemCommandExecutor(final List<String> commandInformation, final String adminPassword, final String targetPath)
    {
            ...
            throws IOException, InterruptedException
    {
        ...
        try
        {
            ProcessBuilder pb = new ProcessBuilder(commandInformation).directory(new File(targetPath));
